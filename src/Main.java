public class Main {
    public static void main(String[] args) {
        ...
        Ravenclaw.comparisonOfStudents(zhouChang, padmaPatil);
        Slytherin.comparisonOfStudents(dracoMalfoy, grahamMontague);

        HogwartsSchool.comparisonOfStudents(harryPotter, dracoMalfoy);
    }
}